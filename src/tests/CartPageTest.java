...
public class CartPageTest {
	...
	public void setup() throws FileNotFoundException, IOException {
		...
		this.locators.load(new FileInputStream("config/locators.properties"));
	...
	public void deleteCookies() {
		...
		Assert.assertTrue(this.driver.findElement(By.xpath(this.locators.getProperty("emptyCartMessage"))).getText()
				.contentEquals("Your cart is empty."));
	}
