...
public class CartPage {
	...
	public WebElement getRemoveButton() {
		return this.driver.findElement(By.xpath(this.locators.getProperty("removeButton")));
	}
	...
	public WebElement getCheckout() {
		return this.driver.findElement(By.xpath(this.locators.getProperty("proccedToCheckout")));
	}
	...
	public List<WebElement> getItemsID() {
		return this.driver.findElements(By.xpath(this.locators.getProperty("itemID")));
	}

	public WebElement getItemsTotalCost() {
		return this.driver.findElement(By.xpath(this.locators.getProperty("totalCost")));
	}
